...
import com.example.dmitriy.emergencyassistant.model.user.personal.Employment;
import com.example.dmitriy.emergencyassistant.model.user.personal.SocialFactor;
...
@Entity
public class EntityUserPersonal {
    ...
    @Expose
    private List<EntityUserPersonalDocument> documents;
    ...
    public List<EntityUserPersonalDocument> getDocuments() {
        return documents;
    }

    public void setDocuments(List<EntityUserPersonalDocument> documents) {
