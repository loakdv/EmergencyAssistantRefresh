...
public class AdapterNeedySelectElement extends RecyclerView.Adapter<AdapterNeedySelectElement.ViewHolder> {
    ...
    public AdapterNeedySelectElement(
    ...
    @Override
    public AdapterNeedySelectElement.ViewHolder onCreateViewHolder(
            ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.element_statevariant, parent, false);
        return new AdapterNeedySelectElement.ViewHolder(view);
    }
