...
public class AdapterNeedyAddedRelatives extends RecyclerView.Adapter<AdapterNeedyAddedRelatives.ViewHolder> {
    ...
    @Override
    public AdapterNeedyAddedRelatives.ViewHolder onCreateViewHolder(
            ViewGroup parent, int viewType) {

        View view = mInflater.inflate(
                R.layout.element_user, parent, false);

        return new AdapterNeedyAddedRelatives.ViewHolder(view);
    }
