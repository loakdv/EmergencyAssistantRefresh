...
public class ActivityDialogStateCheck extends AppCompatActivity implements AdapterNeedyStateSelect.CallBackButtons {


    private List<ElementStateSelect> listSelect= new ArrayList<ElementStateSelect>();
    private AdapterNeedyStateSelect adapterSelect;
    ...
    private void initializeRecycleView(){
        ...
        adapterSelect=new AdapterNeedyStateSelect(
