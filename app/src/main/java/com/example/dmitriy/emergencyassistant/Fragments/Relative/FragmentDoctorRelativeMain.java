...
public class FragmentDoctorRelativeMain<onStart> extends Fragment implements AdapterRelativeAddedNeedy.CallBackButtons, InterfaceOnUpdate {

    private boolean isPaused=false;

    private EntityRelativeAddedNeedy lastNeedy;

    private List<EntityRelativeAddedNeedy> needyfordoc=new ArrayList<EntityRelativeAddedNeedy>();
    ...
    private FragmentNoSelectedNeedy fNone;
    ...
    @Override
    public void select(EntityRelativeAddedNeedy needy) {
        seeInfo(needy.getId());
    ...
    private void seeInfo(String id){
        EntityRelativeAddedNeedy needy=dataBase.dao_relative_addedNeedy().getById(id);
        String name=needy.getName();
        String surname=needy.getSurname();
        String middlename=needy.getMiddlename();
        String info=needy.getInfo();
        fNeedyInfo=new FragmentInfoAboutNeedy(name, surname, middlename, info, id);
    ...
    private void setNone(){
        fNone=new FragmentNoSelectedNeedy();
