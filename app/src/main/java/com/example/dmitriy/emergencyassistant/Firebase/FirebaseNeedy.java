...
public class FirebaseNeedy {
    ...
    public FirebaseNeedy(String profile_id, int sos_signal, int help_signal, int state_signal, String info, String organization){
